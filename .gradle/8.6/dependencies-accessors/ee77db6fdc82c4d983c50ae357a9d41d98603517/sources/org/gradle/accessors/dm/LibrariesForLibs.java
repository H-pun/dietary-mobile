...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AirbnbLibraryAccessors extends SubDependencyFactory {
        private final AirbnbLottieLibraryAccessors laccForAirbnbLottieLibraryAccessors = new AirbnbLottieLibraryAccessors(owner);

        public AirbnbLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>airbnb.lottie</b>
         */
        public AirbnbLottieLibraryAccessors getLottie() {
            return laccForAirbnbLottieLibraryAccessors;
        }

    }

    public static class AirbnbLottieLibraryAccessors extends SubDependencyFactory {

        public AirbnbLottieLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getCompose() {
            return create("airbnb.lottie.compose");
        }
    ...
    public static class AndroidxCameraLibraryAccessors extends SubDependencyFactory {
        private final AndroidxCameraViewfinderLibraryAccessors laccForAndroidxCameraViewfinderLibraryAccessors = new AndroidxCameraViewfinderLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>androidx.camera.viewfinder</b>
         */
        public AndroidxCameraViewfinderLibraryAccessors getViewfinder() {
            return laccForAndroidxCameraViewfinderLibraryAccessors;
        }

    }

    public static class AndroidxCameraViewfinderLibraryAccessors extends SubDependencyFactory {

        public AndroidxCameraViewfinderLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>compose</b> with <b>androidx.camera:camera-viewfinder-compose</b> coordinates and
         * with version reference <b>cameraViewfinderCompose</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCompose() {
            return create("androidx.camera.viewfinder.compose");
        }
    ...
    public static class AndroidxGlanceLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>glanceAppwidget</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class ArrowLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>arrow.core</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCore() {
    ...
    public static class ComposeLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>compose.shimmer</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class KotlinxCoroutinesPlayLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>kotlinxCoroutinesPlayServices</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getServices() {
    ...
    public static class VicoLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Group of libraries at <b>vico.compose</b>
         */
    ...
    public static class VicoComposeLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public VicoComposeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>compose</b> with <b>com.patrykandpatrick.vico:compose</b> coordinates and
        ...
        /**
         * Dependency provider for <b>m3</b> with <b>com.patrykandpatrick.vico:compose-m3</b> coordinates and
         * with version reference <b>vico</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final ArrowVersionAccessors vaccForArrowVersionAccessors = new ArrowVersionAccessors(providers, config);
        ...
        /**
         * Version alias <b>cameraViewfinderCompose</b> with value <b>1.0.0-alpha01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCameraViewfinderCompose() { return getVersion("cameraViewfinderCompose"); }

        /**
         * Version alias <b>camerax</b> with value <b>1.3.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>coilCompose</b> with value <b>2.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>coroutinesTest</b> with value <b>1.8.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>credentials</b> with value <b>1.3.0-alpha04</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>glanceAppwidget</b> with value <b>1.1.0-rc01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getGlanceAppwidget() { return getVersion("glanceAppwidget"); }

        /**
         * Version alias <b>googleGmsGoogleServices</b> with value <b>4.4.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>googleid</b> with value <b>1.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>kotlin</b> with value <b>2.0.0-RC3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>kotlinxCoroutinesPlayServices</b> with value <b>1.8.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKotlinxCoroutinesPlayServices() { return getVersion("kotlinxCoroutinesPlayServices"); }
        ...
        /**
         * Version alias <b>lottieCompose</b> with value <b>6.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>playServicesAuth</b> with value <b>21.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>protobuf</b> with value <b>0.9.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>protobufJavalite</b> with value <b>4.26.0-RC2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>slf4j</b> with value <b>2.0.11</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>vico</b> with value <b>2.0.0-alpha.19</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Group of versions at <b>versions.arrow</b>
         */
        public ArrowVersionAccessors getArrow() {
            return vaccForArrowVersionAccessors;
        }
    ...
    public static class ArrowVersionAccessors extends VersionFactory  {

        public ArrowVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>arrow.core</b> with value <b>1.2.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getCore() { return getVersion("arrow.core"); }
    ...
    public static class ComposeVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>compose.shimmer</b> with value <b>1.1.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getShimmer() { return getVersion("compose.shimmer"); }
    ...
    public static class LeakcanaryVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>leakcanary.android</b> with value <b>2.12</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
