    ...
    override suspend fun provideGlance(context: Context, id: GlanceId) {
        ...
        provideContent {
            ...
            val oneTimeFoodDiary by rememberUpdatedState(
                foodDiaryUseCase.getDiaryFoodsByDaysOnly(
        ...
        LazyColumn(
            ...
            if (isSuccess) {
                ...
                items(4) {
                    ...
                    Column {
                        Row(
                            ...
                            Text(
                                text = "${String.format(locale, "%.2f", totalNutrition)} $unit",
                                style = TextStyle(
                                    fontFamily = FontFamily("roboto"),
                                    fontWeight = FontWeight.Medium,
                            ...
                            Text(
                                text = "${String.format(locale, "%.2f", maxNutrition)} $unit",
                                style = TextStyle(
                                    fontFamily = FontFamily("roboto"),
                                    fontWeight = FontWeight.Medium,
                                    fontSize = DietaryTypeScaleTokens.LabelMediumSize,
                ...
                items(
                    ...
                    Column(modifier = GlanceModifier.fillMaxWidth().clickable{}) {
                ...
                Column(
                    ...
                    Image(
                        ...
                        modifier = GlanceModifier.size(170.dp)
                    )
                    Spacer(GlanceModifier.height(4.dp))
                    Text(
