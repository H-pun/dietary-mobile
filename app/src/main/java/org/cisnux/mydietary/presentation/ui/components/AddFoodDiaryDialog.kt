...
fun AddFoodDiaryDialog(
    ...
    onFoodDiaryCategoryChange: (Int) -> Unit,
                ...
                Column(
                    ...
                    ExposedDropdownMenuBox(
                        ...
                        ExposedDropdownMenu(
                            ...
                            foodDiaryCategories.forEachIndexed { index, selectedOption ->
                                DropdownMenuItem(
                                    text = { Text(selectedOption) },
                                    onClick = {
                                        onFoodDiaryCategoryChange(index)
